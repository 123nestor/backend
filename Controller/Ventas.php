<?php
    class Ventas extends Controllers{
        ...
        {        
            ...
            $data['cli']= $this->model->selectClientes(); 
    ...
    //funcion para ver informe detalle de venta ticket 
    public function ver()
    {
        ...
        $this->views->getView($this, "ticket", $data ,"",$config, $cliente);
        //$this->views->getView($this, "ticket" ,"",$config);
    }

    //funcion para realizar informes
    public function verInforme()
    {
        $config = $this->model->selectConfiguracion();
        $data = $this->model->selectVentas();
        $this->views->getView($this, "informeVentas", $data ,"",$config);
    }

    //funcion para realizar informes Por Fechas
    public function InformeFechas()
    {
        ...
        if(empty($desde) || empty($hasta)){
            ...
            $data = $this->model->selectVentasFecha($desde,$hasta);
        }
        $config = $this->model->selectConfiguracion();
        $this->views->getView($this, "informeVentas", $data ,"",$config);
    }
