...
class Usuarios extends Controllers
{
    ...
    public function insertar()
    {
            ...
            if ($clave != $confirmar) {
                ...
                $insert = $this->model->insertarUsuarios($nombre, $usuario, $direccion, $hash, $telefono, $rol);
                if ($insert > 0) {
                    $alert = 'registrado';
    ...
    public function actualizar()
    {
        ...
        $telefono = $_POST['telefono'];
        $rol = $_POST['rol'];
        $actualizar = $this->model->actualizarUsuarios($nombre, $usuario, $direccion, $telefono ,$rol, $id);
        if ($actualizar == 1) {
            $alert = 'modificado';
        } else {
            $alert =  'error';
