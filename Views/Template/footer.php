        <footer class="footer">
            <div class="footer__block block no-margin-bottom">
                <div class="container-fluid text-center">
                    <p class="no-margin-bottom"><?php echo date("Y"); ?> &copy; Supermercado-Canasta - Desarrollado por <a href="#">Nestor Acho Huayhua</a>.</p>
                </div>
            </div>
        </footer>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content bg-white">
                    ...
                    <div class="modal-body">
                        <p class="text-dark">¿Esta seguro que desea salir</p>
                    </div>
                    <div class="modal-footer ml-auto">
                        <a href="<?php echo base_url(); ?>Usuarios/salir" class="btn btn-danger">Si</a>
                        <button class="btn btn-warning" data-dismiss="modal" type="button">No</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!--Este libreria es para reportes graficos-->
        <script src="<?php echo base_url(); ?>Assets/js/chartjs.min.js"></script>
        <script src="<?php echo base_url(); ?>Assets/js/all.min.js"></script>
        <script src="<?php echo base_url(); ?>Assets/js/front.js"></script>
        <!--Este libreria es para el select2-->
        
        <script src="<?php echo base_url(); ?>Assets/js/select2.min.js"></script>
        <script src="<?php echo base_url(); ?>Assets/js/bootstrap-select.min.js"></script>
        <!--Este libreria es para mandar alertas en javascript-->
        <script src="<?php echo base_url(); ?>Assets/js/sweetalert2@9.js"></script>
        <!--Este libreria es para generar las tablas y el buscador-->
